                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('img/IMG_20221226_184901_065-removebg-preview.png') }}" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Nama saya is Vernanda Septia Wanandi.</p>
                            <p class="text-muted">Saya lulusan S1 Sistem Informasi dari Institut Teknologi dan Bisnis Palcomtech dengan IPK 3,73. Saya memiliki kemampuan membuat web atau API menggunakan Framework Laravel, dan mampu membuat aplikasi mobile menggunakan Framework Flutter dengan state managemen Getx. Dapat bekerja individu maupun sebagai tim, memiliki semangat tinggi untuk berkembang, bermotivasi tinggi dan tertarik untuk mempelajari hal hal baru. Semoga passion dan minat ini bisa menjadikan saya sebagai asset untuk tergabung kedalam organisasi/tim, semoga bermanfaat dan berguna dengan baik.</p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                ...
                                <a class="text-gradient" href="https://instagram.com/nandicode"><i class="bi bi-instagram"></i></a>
                                <a class="text-gradient" href="https://www.linkedin.com/in/vernandaspw"><i class="bi bi-linkedin"></i></a>
                                <a class="text-gradient" href="https://github.com/vernandaspw"><i class="bi bi-github"></i></a>
                                <a class="text-gradient" href="https://facebook.com/vernanda.spw"><i class="bi bi-facebook"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-11 col-xl-9 col-xxl-8">
                        ...
                        <a href="http://sikeuangan.com/" class="card overflow-hidden text-decoration-none text-dark shadow rounded-4 border-0">
                            <div class="card-body text-center p-0">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="p-5">
                                        <img src="{{ asset('img/sikeuangan/logo-bg-white.jpg') }}" width="70" height="70" alt="">
                                        <h2 class="fw-bolder">SIKeuangan</h2>
                                        <p>
                                            Sistem Informasi Keuangan Akuntansi, mempermudah mengelola keuangan untuk bisnis, pribadi ataupun keluarga. Support Integrasi API
                                        </p>
                                    </div>
