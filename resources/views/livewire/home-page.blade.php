                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase" style="font-size: 14px">Web Developer & Mobile Application
                                Developer</div>
                        </div>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">

                            <a class="btn btn-success rounded-pill btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                target="_blank" rel="noopener noreferrer" href="{{ asset('CV.pdf') }}">Download CV</a>
                        ...
                        <div class="d-flex justify-content-center justify-content-xxl-start fs-2 gap-4">
                            ...
                            <a class="text-success" href="https://github.com/vernandaspw"><i
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img"
                                src="{{ asset('img/IMG_20221226_184901_065-removebg-preview.png') }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row d-flex align-items-center">
                <div class="col-md-6 ps-5">
                    ...
                    <p class=" text-start">Saya lulusan S1 Sistem Informasi dari Institut Teknologi dan Bisnis
                        ...
                        bekerja individu maupun sebagai tim, memiliki semangat tinggi untuk berkembang, bermotivasi
                        tinggi
                        dan tertarik untuk mempelajari hal hal baru. Semoga passion dan minat ini bisa menjadikan saya
                        sebagai asset untuk tergabung kedalam organisasi/tim, semoga bermanfaat dan berguna dengan baik.
                    </p>
                </div>
                <div class="col-md-6  ps-5">
                    <table>
                        ...
                        <div class="card-body text-center p-0">
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="p-5">
                                    ...
                                    <p>
                                        Sistem Informasi Keuangan Akuntansi, mempermudah mengelola keuangan untuk
                                        bisnis,
                        ...
                        <div class="card-body text-center p-0">
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="p-5">
                                    ...
                                    <p>
                                        Beres Digital adalah agensi Digital yang dilengkapi dengan beragam solusi
                                        lengkap
                                        untuk mendukung proses perkembangan dan transformasi digital bisnis anda. Mulai
                                        dari
                                        pembuatan website berkualitas, perumusan strategi iklan digital berbagai
                                        channel,
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center mt-5">
                        ...
                        <p class="lead fw-light mb-2" style="font-size: 18px">Terima Pembuatan berbagai website &
                            aplikasi
                            dengan harga termurah
                        </p>
                        <p class="lead fw-light mb-2" style="font-size: 18px">Untuk kebutuhan Bisnis, Usaha, Tugas
                            Akhir,
                            Skripsi</p>
            ...
            <div class="row gx-5 justify-content-center">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="card bg-white">
                        ...
                        <div class="card-body">
                            <div class="">
                                Menyediakan maintance Diluar Proses Project Selesai jika Ada bug, Penambahan /
                                Pengubahan
                                Filtur
                            </div>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="">
                                                Proses pengerjaan mulai dari 1 hari, sesuai tingkat kategori yang
                                                dipilih
                                            </div>
                                        </div>
                                    </div>
